...
const {
  applyToBooking,
  getMyAppliedBookings,
  getApplicationsForBooking,
  updateApplicationStatus,
  withdrawApplication,
  notifyCancellationByArtist,
  completeApplication,
  addApplicationNote,
  getApplicationNotes,
...
router.get(
  ...
  protect,
  reviewController.listCompletedBookingsForClient
);
...
router.get(
  ...
  protect,
  reviewController.getMyReviewForBooking
);
...
router.get(
  "/api/applications/booking/:bookingId",
  protect,
  getApplicationsForBooking
);
router.put(
...
router.post(
  "/api/payments/remaining-checkout",
  protect,
  createRemainingCheckoutSession
);
...
router.get(
  ...
  portfolioController.getArtistPortfolio
);
...
router.get(
  ...
  protect,
  adminOnly,
  adminController.getApplicationsStatus
);
router.get(
  "/api/admin/applications",
  protect,
  adminOnly,
  adminController.listAllApplications
);
router.put(
...
router.post(
  "/api/admin/applications/cancel",
  protect,
  adminOnly,
  adminController.notifyCancellationByAdmin
);
...
router.get(
  "/api/admin/analytics/requests-by-status",
  protect,
  adminOnly,
...
router.get(
  ...
  protect,
  adminOnly,
  adminController.getApplicationsByStatus
);
router.get(
  "/api/admin/analytics/growth-over-time",
  protect,
  adminOnly,
  adminController.getGrowthOverTime
);
router.get(
  "/api/admin/analytics/activity-by-city",
  protect,
  adminOnly,
  adminController.getActivityByCity
);
module.exports = router;
