...
import { FaStar, FaInstagram, FaFacebook, FaTiktok, FaCar, FaHome, FaPaperclip, FaPen, FaCamera, FaSpinner, FaTimes } from 'react-icons/fa';
  ...
  useEffect(() => {
    const fetchPortfolioData = async () => {
      ...
      try {
        ...
        const portfolioResponse = await portfoliosAPI.getArtistPortfolio(artist._id);
        ...
        <div style={{
          ...
          {portfolioLoading && (
            <div style={{
              ...
              <p style={{ margin: 0, color: '#6b7280' }}>Loading portfolio...</p>
            </div>
          )}
            ...
            <>
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  {portfolioData.aboutMe || portfolioData.bio || 'No bio provided yet.'}
                </p>
              </div>
                  ...
                  <div>
                    ...
                    {getEnabledServices().map((service, index) => (
                      <div key={index} style={{
                        ...
                        gap: '12px',
                        padding: '8px 0',
                        borderBottom: index < getEnabledServices().length - 1 ? '1px solid #f3f4f6' : 'none'
                      }}>
              ...
              <div style={{
                ...
                {portfolioData.mediaUrls && portfolioData.mediaUrls.length > 0 ? (
                  <div style={{
                    display: 'grid',
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  <div>
                    ...
                    <p style={{ color: '#6b7280', margin: 0 }}>
                      {portfolioData.languagesSpoken && Array.isArray(portfolioData.languagesSpoken) && portfolioData.languagesSpoken.length > 0
                        ? portfolioData.languagesSpoken.join(', ')
                        : portfolioData.languagesSpoken && typeof portfolioData.languagesSpoken === 'string' && portfolioData.languagesSpoken.trim()
