...
import { FaStar, FaInstagram, FaFacebook, FaTiktok, FaCar, FaHome, FaPaperclip, FaPen, FaCamera, FaSpinner } from 'react-icons/fa';
      ...
      <div style={{ 
        ...
        <div>
          ...
          <div style={{
            ...
            {portfolioData?.portfolioImages && portfolioData.portfolioImages.length > 0 ? (
              <div style={{ 
                display: 'grid', 
          ...
          <div style={{
            ...
            <h2 style={{ 
              ...
              <FaInstagram style={{ color: '#ff6b35' }} />
              Social Links
            </h2>
