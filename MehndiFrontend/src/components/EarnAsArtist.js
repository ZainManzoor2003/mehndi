      ...
      <main className="main" style={{ paddingTop: "80px" }}>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                All chats and payments happen safely through our platform — no
                more chasing payments or DMs.
              </p>
            </div>
            ...
            >
              ...
              >
                From bookings to reminders, we keep your calendar organized so
        ...
        >
          ...
          >
            ...
            >
              We charge a small service fee to support you and the platform. Tap
              a card below to see how our values shape our pricing.
            </p>
              ...
              <div className="flip-card">
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back">
                    ...
                    >
                      As a <strong>Founding Artist</strong>, enjoy{" "}
                      <strong>0% commission for your first 2 months</strong> —
                      keep 100% of your earnings while you grow.
                      <br />
                      After that, a simple <strong>15% commission</strong>{" "}
                      applies — no surprises, no hidden fees.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flip-card">
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back">
                    ...
                    >
                      Our service fee supports platform growth, artist
                      promotion, marketing, tech, and client support — all for
                      you.
                    </p>
                  </div>
                </div>
              ...
              <div className="flip-card">
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back">
                    ...
                    >
                      We're more than a platform — we're a community where
                      artists feel seen, valued, and supported like family.
                    </p>
                  </div>
                </div>
              </div>
        ...
        >
          <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
            ...
            >
              {" "}
              <span
                style={{ fontSize: "4.5rem", color: "var(--accent-orange)" }}
              >
                ''
              </span>
              {/* <div style={{
        ...
        >
          <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
            ...
            >
              ...
              >
                Create your artist profile in minutes and start getting booked
                by clients who love your style.
              </p>
              <Link to="/signup" className="home__cta-button">
                Get Started →
              </Link>
