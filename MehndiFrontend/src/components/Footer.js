  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            className="footer__content footer__brand"
          ...
          >
            ...
            <p className="footer__description">
              ...
              designs. Your trusted platform for authentic mehndi experiences.
            </p>
          </div>
            ...
            <ul className="footer__list">
              <li>
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    navigate("/earn-as-artist");
                  }}
                >
                  Earn as a Mehndi Artist
                </a>
              </li>
              <li>
                <a
              ...
              <li>
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    handleLinkClick("/faq?tab=artists");
                  }}
                >
                  FAQs for Artists
                </a>
            ...
            <ul className="footer__list">
              ...
              <li>
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    handleLinkClick("/faq?tab=clients");
                  }}
                >
                  FAQs for Clients
                </a>
