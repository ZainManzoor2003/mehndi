  ...
  useEffect(() => {
    ...
    if (selectedRole?.value) {
      filtered = filtered.filter(
        (user) => user.userType === selectedRole.value
      );
    }
  ...
  return (
    <div className="admin_dashboard-layout">
      <ConfirmActionModal
        ...
        message="This will permanently remove this user from the platform. This action cannot be undone."
          ...
          <div className="admin_dashboard-content">
            ...
            <div className="admin_booking-stats">
              ...
              <div className="admin_stat-card">
                ...
                <div className="admin_stat-info">
                  <h3>Admin Users</h3>
                  <span className="admin_stat-number">
              ...
              <div className="admin_stat-card">
                ...
                <div className="admin_stat-info">
                  <h3>Artist Users</h3>
                  <span className="admin_stat-number">
                    {users.filter((u) => u.userType === "artist").length}
                  </span>
                </div>
              </div>
            ...
            {loading ? (
              ...
              <>
                ...
                <div
                  className="admin_table-responsive"
                ...
                {filteredUsers.length > 0 && (
                  <div
                    className="admin_pagination-container"
                    style={{
                      display: "flex",
                    ...
                    >
                        ...
                        {getPageNumbers().map((pageNum) => (
                          <button
                            ...
                            style={{
                              padding: "0.5rem 0.75rem",
                              border: `1px solid ${
                                currentPage === pageNum ? "#3b82f6" : "#e5e7eb"
                              }`,
                              borderRadius: "6px",
                              backgroundColor:
                                currentPage === pageNum ? "#3b82f6" : "#ffffff",
                              color:
                                currentPage === pageNum ? "#ffffff" : "#0f172a",
                              fontSize: "0.875rem",
                              cursor: "pointer",
                              transition: "all 0.2s",
                              minWidth: "40px",
                      ...
                      <button
                        ...
                        style={{
                          ...
                          borderRadius: "6px",
                          backgroundColor:
                            currentPage === totalPages ? "#ffffff" : "#ffffff",
                          color:
                            currentPage === totalPages ? "#9ca3af" : "#0f172a",
                          fontSize: "0.875rem",
                          cursor:
              ...
              <div className="admin_modal-overlay" onClick={closeEdit}>
                ...
                >
                  <div className="admin_modal-header">
                    ...
                    <button className="admin_modal-close" onClick={closeEdit}>
                      ×
                    </button>
                  </div>
                  <form
