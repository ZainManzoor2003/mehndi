          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "2rem 2.5rem" }}>
            ...
            >
              ...
              <div>
                ...
                >
                  {viewForm.eventDate
                    ? new Date(viewForm.eventDate).toLocaleDateString("en-GB", {
                        weekday: "long",
                        year: "numeric",
                        month: "long",
                        day: "numeric",
                    ...
                    >
                      {viewForm.designInspiration.map((url, idx) => (
                        <div
                          ...
                          onMouseLeave={(e) => {
                            e.currentTarget.style.borderColor = "#e0d5c9";
            ...
            {showApply && (
              <button
                ...
                style={{
                  ...
                  fontWeight: "600",
                  color: "white",
                  backgroundColor: applied ? "#9ca3af" : "#b45309",
                  border: "none",
                  borderRadius: "12px",
