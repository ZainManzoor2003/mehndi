  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Here are some common questions from our Mehndi community{" "}
            ...
            return (
              ...
              >
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.querySelector(".faq-q")?.style &&
                      (e.currentTarget.querySelector(".faq-q").style.color =
                        "var(--accent-orange, #D2691E)");
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.querySelector(".faq-q")?.style &&
                      (e.currentTarget.querySelector(".faq-q").style.color =
      ...
      <div style={{ textAlign: "center", marginTop: "2rem" }}>
        <button onClick={() => navigate("/faq")} className="home__cta-button">
          View All FAQs →
        </button>
      </div>
    </section>
